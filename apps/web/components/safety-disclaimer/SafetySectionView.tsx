...
import { SafetySection } from "../../app/safety-disclaimer/safety-disclaimer-content";

interface SafetySectionViewProps {
  section: SafetySection;
}

export function SafetySectionView({ section }: SafetySectionViewProps) {
  return (
    <article
      id={section.id}

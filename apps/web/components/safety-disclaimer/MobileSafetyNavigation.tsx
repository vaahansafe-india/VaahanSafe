...
interface MobileSafetyNavigationProps {
  sections?: readonly SafetySection[];
}

export function MobileSafetyNavigation({
  sections = SAFETY_SECTIONS,
}: MobileSafetyNavigationProps) {
        ...
        >
          <SheetHeader className="text-left">
            ...
            <SheetDescription className="font-mono text-[7px] uppercase tracking-[0.14em] text-muted-foreground dark:text-zinc-500">
              Jump directly to any safety section
            </SheetDescription>
          </SheetHeader>

          <hr className="my-4 border-border dark:border-white/[0.08]" />

          <nav aria-label="Mobile safety sections index" className="flex flex-col gap-1">

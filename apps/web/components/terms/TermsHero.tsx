...
export function TermsHero() {
  return (
    ...
    >
      {/* ========================================================== */}
      {/* AMBIENT IDENTITY GEOMETRY (VaahanSafe Vehicle System)      */}
      {/* ========================================================== */}
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 overflow-hidden"
      >
        {/* Primary registration arc */}
        <span
          className="
        ...
        {/* Secondary registration arc with coral tint */}
        <span
          className="
        ...
        {/* Registration coordinates and markers */}
        <span
          className="
      ...
      <div className="relative mx-auto max-w-[1240px] px-5 sm:px-8 lg:px-10">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 font-mono text-[7px] uppercase tracking-[0.18em] text-muted-foreground/70 dark:text-zinc-500">
            <span>{TERMS_META.documentId}</span>
            <span className="h-1 w-1 rounded-full bg-[#cc785c]/60" />
            <span>VaahanSafe Terms of Service</span>
          </div>
        </div>
        ...
        <div className="mt-8 max-w-[880px]">
          ...
          >
            The terms behind
            <br />
            <span className="text-[#cc785c]">your VaahanSafe identity.</span>
          </h1>
          ...
          >
            ...
            you create an account, activate or use a VaahanSafe vehicle identity,
            purchase related services, or use other VaahanSafe features.
          </p>
        </div>
        ...
        >
          <div className="flex items-center gap-2">
            <span className="text-muted-foreground/70 dark:text-zinc-500">TERMS OF SERVICE</span>
          </div>

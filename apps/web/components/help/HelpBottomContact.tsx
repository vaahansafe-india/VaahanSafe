...
export function HelpBottomContact() {
        ...
        <div className="flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
          <div className="max-w-[620px]">
            ...
            <p className="mt-3 text-sm leading-relaxed text-[#a1a1aa]">
              Our support team assists with activation key inquiries, replacement verifications, and fleet integrations. You can also review official policy documentation or check platform availability.
            </p>
          </div>

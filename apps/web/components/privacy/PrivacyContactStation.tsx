...
export function PrivacyContactStation() {
  return (
    <section
      ...
      <div className="mt-6 grid gap-8 lg:grid-cols-[1.4fr_1fr] lg:items-end">
        <div>
          ...
          <p className="mt-4 max-w-[560px] text-xs leading-relaxed text-muted-foreground sm:text-sm sm:leading-7 dark:text-zinc-400">
            If you have a privacy question, want to request data rectification, or wish to exercise any of your rights under Indian privacy governance, reach out to our dedicated privacy desk.
          </p>

          <div className="mt-8 flex flex-wrap items-center gap-4">
            <a
              href="mailto:support@vaahansafe.com?subject=Privacy%20Request%20-%20VaahanSafe"
              className="
              ...
              "
            >
              <span>Make a privacy request</span>

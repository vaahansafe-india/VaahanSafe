...
import { PolicySection } from "../../app/privacy/privacy-policy-content";

interface PolicySectionViewProps {
  section: PolicySection;
}

export function PolicySectionView({ section }: PolicySectionViewProps) {
  return (
    <article
      id={section.id}
      ...
      <div className="mt-8 space-y-8">
        {section.subsections.map((sub) => (
          <div key={sub.id} className="border-t border-border/70 pt-6 dark:border-white/[0.06]">
            ...
            <div className="mt-3 space-y-3 text-xs leading-[1.8] text-[#3f3f46] sm:text-[13px] sm:leading-[1.85] dark:text-zinc-400">

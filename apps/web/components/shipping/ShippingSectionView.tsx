...
import { ShippingSection } from "../../app/shipping-replacement/shipping-replacement-content";

interface ShippingSectionViewProps {
  section: ShippingSection;
}

export function ShippingSectionView({ section }: ShippingSectionViewProps) {
  return (
    <article
      id={section.id}

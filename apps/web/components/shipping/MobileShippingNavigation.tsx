...
import { SHIPPING_SECTIONS, type ShippingSection } from "../../app/shipping-replacement/shipping-replacement-content";

interface MobileShippingNavigationProps {
  sections?: readonly ShippingSection[];
}

export function MobileShippingNavigation({
  sections = SHIPPING_SECTIONS,
}: MobileShippingNavigationProps) {
    ...
    <div className="sticky top-16 z-30 flex items-center justify-between border-b border-border bg-background/95 px-5 py-3 backdrop-blur-md lg:hidden dark:border-border dark:bg-zinc-950/95">
      ...
      <Sheet open={open} onOpenChange={setOpen}>
        ...
        >
          ...
          <nav aria-label="Mobile shipping sections index" className="flex flex-col gap-1">

...
export const metadata: Metadata = {
  title: "Security & Sessions — VaahanSafe",
  description: "Manage active device sessions, authentication cookies, and account security.",
};
  ...
  return (
    <div className="space-y-6">
      ...
      <Suspense fallback={<SettingsSkeleton />}>
        <SettingsShell initialData={initialData} defaultCategory="security" />
      </Suspense>
    </div>
  );
}

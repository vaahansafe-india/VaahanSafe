...
export function DashboardHeader({
  ...
  return (
    <header className="flex flex-col justify-between gap-4 border-b border-border/60 pb-6 lg:flex-row lg:items-end">
      {/* Editorial Identity Header */}
      <div className="space-y-1.5">
        <div className="flex items-center gap-3">
          <span className="font-mono text-[11px] font-semibold uppercase tracking-[0.24em] text-[#cc785c]">
            VAAHANSAFE / CUSTOMER IDENTITY
          </span>
          <span className="hidden sm:inline-block h-1 w-1 rounded-full bg-border" />
          <span className="hidden sm:inline-flex items-center gap-1.5 font-mono text-[10px] uppercase tracking-wider text-muted-foreground">
      ...
      <div className="flex flex-wrap items-center gap-2 sm:gap-3">
        ...
        <button
          ...
          className="hidden sm:flex h-10 items-center gap-2 rounded-xl border border-border bg-card px-3 text-xs text-muted-foreground shadow-2xs transition-all hover:border-[#cc785c]/40 hover:text-foreground"
        ...
        <button
          ...
          className="flex h-10 items-center gap-2 rounded-xl border border-border bg-card px-3.5 text-xs font-medium text-foreground shadow-2xs transition-all hover:border-[#cc785c]/40 hover:shadow-xs"
        >
        ...
        <button
          ...
          className="relative flex h-10 w-10 items-center justify-center rounded-xl border border-border bg-card text-foreground shadow-2xs transition-all hover:border-[#cc785c]/40 hover:shadow-xs"
